...
import com.example.calfit.databinding.FragmentMainBinding
import com.google.android.material.dialog.MaterialAlertDialogBuilder
import com.google.mlkit.vision.pose.PoseDetector
import com.oguzhancetin.goodpostureapp.aspectRatio
import com.oguzhancetin.goodpostureapp.data.model.Record
import com.oguzhancetin.goodpostureapp.getOutputDirectory
import com.oguzhancetin.goodpostureapp.rotateImageWithUri
...
//        it.forEach{permission -> if(!permission.value) permissionsState = false}
        if(permissionsState){
            startCamera()
        }else{
            Toast.makeText(
    ...
    private fun allPermissionsGranted():Boolean {  if(ContextCompat.checkSelfPermission(this.requireContext(), Manifest.permission.CAMERA)
    ...
    private fun requestPermission() {
        ActivityCompat.requestPermissions(
            this.requireActivity(), arrayOf<String>(Manifest.permission.CAMERA),
